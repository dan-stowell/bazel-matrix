...
#
# TODO: add periphery_archive to _PROJECT_SOURCES in //bazel_runner:extension.bzl.
# TODO: add "periphery_archive" to the project_sources use_repo() call in MODULE.bazel.
...
PERIPHERY_PROJECT = project_spec(
    name = "periphery",
    source = tarball_source(
        archive = "@periphery_archive//file",
        strip_prefix = "TODO",
    ),
