...
#
# TODO: add cxxopts_archive to _PROJECT_SOURCES in //bazel_runner:extension.bzl.
# TODO: add "cxxopts_archive" to the project_sources use_repo() call in MODULE.bazel.
...
CXXOPTS_PROJECT = project_spec(
    name = "cxxopts",
    source = tarball_source(
        archive = "@cxxopts_archive//file",
        strip_prefix = "TODO",
    ),
