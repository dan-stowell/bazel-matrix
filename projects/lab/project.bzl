...
# Upstream: https://github.com/google-deepmind/lab
# Description: A customisable 3D platform for agent-based AI research
#
# TODO: add lab_archive to _PROJECT_SOURCES in //bazel_runner:extension.bzl.
# TODO: add "lab_archive" to the project_sources use_repo() call in MODULE.bazel.
...
LAB_PROJECT = project_spec(
    name = "lab",
    source = tarball_source(
        archive = "@lab_archive//file",
        strip_prefix = "TODO",
    ),
