...
#
# TODO: add drake_archive to _PROJECT_SOURCES in //bazel_runner:extension.bzl.
# TODO: add "drake_archive" to the project_sources use_repo() call in MODULE.bazel.
...
DRAKE_PROJECT = project_spec(
    name = "drake",
    source = tarball_source(
        archive = "@drake_archive//file",
        strip_prefix = "TODO",
    ),
