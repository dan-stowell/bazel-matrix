...
#
# TODO: add pico_sdk_archive to _PROJECT_SOURCES in //bazel_runner:extension.bzl.
# TODO: add "pico_sdk_archive" to the project_sources use_repo() call in MODULE.bazel.
...
PICO_SDK_PROJECT = project_spec(
    name = "pico-sdk",
    source = tarball_source(
        archive = "@pico_sdk_archive//file",
        strip_prefix = "TODO",
    ),
