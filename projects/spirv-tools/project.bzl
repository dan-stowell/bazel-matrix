...
# Description: spirv_tools
#
# TODO: add spirv_tools_archive to _PROJECT_SOURCES in //bazel_runner:extension.bzl.
# TODO: add "spirv_tools_archive" to the project_sources use_repo() call in MODULE.bazel.
...
SPIRV_TOOLS_PROJECT = project_spec(
    name = "spirv-tools",
    source = tarball_source(
        archive = "@spirv_tools_archive//file",
        strip_prefix = "TODO",
    ),
